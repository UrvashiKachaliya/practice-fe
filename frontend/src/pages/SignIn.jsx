    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-orange-400 via-orange-500 to-amber-600 flex-col items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white">
          ...
          <p className="text-orange-100 text-lg font-medium mb-8">Crispy. Healthy. Delicious.</p>
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8 border border-orange-100">
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-500">
                {/* New to Khakhra Co.?{" "} */}
                <Link to="/signup" className="text-orange-500 font-semibold hover:underline">Create account</Link>
              </p>
            </div>
          </div>
        </div>
