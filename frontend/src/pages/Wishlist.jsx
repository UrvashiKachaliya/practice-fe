      ...
      <div className="max-w-4xl mx-auto">
        ...
        {items.length === 0 ? (
          <div className="bg-white rounded-3xl shadow-sm border border-orange-100 py-16 px-6 flex flex-col items-center gap-5 text-center">
            ...
            <Link to="/products" className="bg-gradient-to-r from-orange-500 to-amber-500 text-white px-8 py-3 rounded-xl font-bold text-sm hover:from-orange-600 hover:to-amber-600 shadow-md shadow-orange-200 transition-all">
              Browse Khakhras
            </Link>
          </div>
        ) : (
