    ...
    <div className="min-h-screen bg-amber-50 py-10 px-4">
      <div className="max-w-3xl mx-auto">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-2xl font-extrabold text-gray-800">My Cart</h2>
        </div>
        ...
        {items.length === 0 ? (
          <div className="bg-white rounded-3xl shadow-sm border border-orange-100 p-16 flex flex-col items-center gap-5 text-center">
            <div className="w-24 h-24 rounded-full bg-orange-50 flex items-center justify-center">
              <FaShoppingCart size={40} className="text-orange-300" />
            </div>
            <div>
              <h3 className="text-lg font-bold text-gray-700 mb-1">Your cart is empty</h3>
              <p className="text-gray-400 text-sm">Add some crispy khakhras to your cart and enjoy the crunch!</p>
            </div>
            <Link
              to="/products"
